...
function renderCrossroadsHero(){
    ...
    if(!hero) { console.warn('[Crossroads] hero div not found'); return; }
    if(typeof CROSSROADS_PATHS==='undefined'||!CROSSROADS_PATHS||!CROSSROADS_PATHS.length) {
        hero.innerHTML='<p style="color:#fff;text-align:center;padding:40px;">جارٍ التحميل...</p>'; return;
    }
    var lang=(typeof currentLang!=='undefined'?currentLang:'ar');
